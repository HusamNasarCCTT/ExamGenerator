...
public class ExamDBHandler extends SQLiteOpenHelper {
    ...
    public String getTeacherName(int teacherId, Context _context){
    ...
    public Vector<Bundle> readteacher(){
            Vector<Bundle> teacherList = new Vector<Bundle>();
            SQLiteDatabase db = getWritableDatabase();

            String query = "SELECT * FROM " + TABLE_TEACHER + " WHERE 1;";
    ...
    public Vector<Bundle> readCourse(){
        ...
        Vector<Bundle> courseVector = new Vector<Bundle>();
        SQLiteDatabase db = getWritableDatabase();
